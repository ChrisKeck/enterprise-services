...
import { FeelingComponent } from 'app/entities/efwservice/feeling/feeling.component';
...
describe('Component Tests', () => {
  describe('Feeling Management Component', () => {
    let comp: FeelingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FeelingComponent, '')
        .compileComponents();
