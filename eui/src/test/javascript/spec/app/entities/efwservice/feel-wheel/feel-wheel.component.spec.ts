...
import { FeelWheelComponent } from 'app/entities/efwservice/feel-wheel/feel-wheel.component';
...
describe('Component Tests', () => {
  describe('FeelWheel Management Component', () => {
    let comp: FeelWheelComponent;
    let fixture: ComponentFixture<FeelWheelComponent>;
    let service: FeelWheelService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [EuiTestModule],
        declarations: [FeelWheelComponent],
        providers: [
          {
        ...
        .overrideTemplate(FeelWheelComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(FeelWheelComponent);
