...
import { BestellungComponent } from 'app/entities/glservice/bestellung/bestellung.component';
...
describe('Component Tests', () => {
  describe('Bestellung Management Component', () => {
    let comp: BestellungComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BestellungComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bestellungs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
