...
import { KollegeComponent } from 'app/entities/glservice/kollege/kollege.component';
...
describe('Component Tests', () => {
  describe('Kollege Management Component', () => {
    let comp: KollegeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KollegeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.kolleges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
