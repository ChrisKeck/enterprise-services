...
@Component({
  selector: 'jhi-feel-wheel',
  templateUrl: './feel-wheel.component.html'
})
export class FeelWheelComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.feelWheelService
      ...
      .subscribe(
        (res: HttpResponse<IFeelWheel[]>) => this.paginateFeelWheels(res.body, res.headers),
  ...
  trackId(index: number, item: IFeelWheel) {
    return item.id;
  }
  ...
  protected paginateFeelWheels(data: IFeelWheel[], headers: HttpHeaders) {
